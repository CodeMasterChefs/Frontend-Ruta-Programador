...
const Fileplaylist = ({ Titulo, Fecha, Duracion, KeyOrderValue, UrlImg, IdPlaylist, IdElemento, KeyElemento }) => {
      ...
      <div className="row video-elente-file">
        ...
        <div className="col-1 d-flex align-items-center justify-content-center">
          ...
          <ul className="dropdown-menu">
            <li>
              <Link to={`/mis_playlists/${IdPlaylist}/reproducir?v=${IdElemento}$key=${KeyElemento}`}>
