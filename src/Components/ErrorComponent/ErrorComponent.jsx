...
const ErrorComponent = ({ children }) => {
  return (
    <div className="container-fluid height-error_component d-flex align-items-start">
      <div className="row d-flex align-items-center justify-content-center container-error-text-image">
